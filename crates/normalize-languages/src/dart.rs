...
mod tests {
    ...
    fn unused_node_kinds_audit() {
        ...
        let documented_unused: &[&str] = &[
            ...
            "optional_formal_parameters", "optional_parameter_types",
