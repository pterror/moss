...
mod tests {
    ...
    fn unused_node_kinds_audit() {
        ...
        let documented_unused: &[&str] = &[
            // STRUCTURAL
            "as_operator", "catch_keyword",
            "computed_modify", "constructor_expression", "constructor_suffix",
            "deinit_declaration", "deprecated_operator_declaration_body", "didset_clause",
            "else", "enum_type_parameters",
            ...
            "precedence_group_declaration", "property_behavior_modifier",
            "property_modifier", "protocol_body", "protocol_composition_type",
            "self_expression",
            "setter_specifier", "statement_label", "statements",
            ...
            "type_arguments", "type_constraint", "type_constraints",
